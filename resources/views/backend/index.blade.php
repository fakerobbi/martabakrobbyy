    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          ...
          <a class="card-footer text-white clearfix small z-1" href="{{route ('admin.menu.index')}}">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          ...
          <a class="card-footer text-white clearfix small z-1" href="{{route ('admin.cabang.index')}}">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
